...
```text
https://your-github-pages-url/reading.html?lesson=europe-dam-removal
```
...
```html
<p><a href="https://sakurahui-coding.github.io/jasper-language-lab/reading.html?lesson=europe-dam-removal">開始互動學習</a></p>
```
